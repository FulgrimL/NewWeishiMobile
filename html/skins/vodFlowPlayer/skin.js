...
(function(a) {
	SewisePlayerSkin.ElementObject = function() {
		...
		this.$ccmiddle = this.$sewisePlayerUi.find(".cc-middle");
		this.$bigpausebtn = this.$sewisePlayerUi.find(".big-pause-btn");
	}
})(window.jQuery);
(function(a) {
...
(function(a) {
	SewisePlayerSkin.ControlBar = function(b, c, k, i) {
		...
		bgbtn.click(function(){
			ca ? n.pause() : n.play(),1000
			
			setTimeout(function(){ba.show();ccmiddle.hide();},100);
		})
		z.dblclick(function() {
			ccmiddle.show();
